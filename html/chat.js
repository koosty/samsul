...
class ChatAI {
    ...
    _welcomePageTemplate() {
        return `
            <div class="welcome">
                <h1>Samsul<span class="ver">${this.options.version}</span></h1>                    
                <p>Made with love by <a href="https://github.com/mitrais-dev/ai-llm" target="_blank">AI Initiative Group</a> &lt;3</p>
                <a href="#" class="open-database"><i class="fa-regular fa-folder-open"></i>Load local history...</a>
            </div>
        `;
    }
